...
public class TViewAllAssignments {
    ...
    public void i_am_at_the_teacher_homepage() {
        TestRunner.driver.get("http://ec2-54-242-235-6.compute-1.amazonaws.com/t_homepage.html");
    ...
    public void i_will_see_all_the_submitted_assignments() {
        ...
        wdw.until(ExpectedConditions.urlToBe("http://ec2-54-242-235-6.compute-1.amazonaws.com/t_view_assignments.html"));
        Assert.assertEquals(TestRunner.driver.getCurrentUrl(), "http://ec2-54-242-235-6.compute-1.amazonaws.com/t_view_assignments.html");
    }
}

...
public class LoginTeacher {
    ...
    public void i_am_at_the_teacher_login_page() {
        ...
        wdw.until(ExpectedConditions.urlToBe("http://ec2-54-242-235-6.compute-1.amazonaws.com/t_login.html"));
    }
    ...
    public void i_should_be_redirected_to_the_teacher_homepage() {
        WebDriverWait wdw = new WebDriverWait(TestRunner.driver, Duration.ofSeconds(10));
        wdw.until(ExpectedConditions.urlToBe("http://ec2-54-242-235-6.compute-1.amazonaws.com/t_homepage.html"));
        Assert.assertEquals(TestRunner.driver.getCurrentUrl(), "http://ec2-54-242-235-6.compute-1.amazonaws.com/t_homepage.html");
    }
    ...
    public void i_should_stay_on_the_teacher_login_page() {
        ...
        wdw.until(ExpectedConditions.urlToBe("http://ec2-54-242-235-6.compute-1.amazonaws.com/t_login.html"));
        Assert.assertEquals(TestRunner.driver.getCurrentUrl(), "http://ec2-54-242-235-6.compute-1.amazonaws.com/t_login.html");
    }
}

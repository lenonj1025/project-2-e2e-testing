...
public class SFilterAssignments {
    ...
    public void i_am_at_the_student_homepage() {
        TestRunner.driver.get("http://ec2-54-242-235-6.compute-1.amazonaws.com/s_homepage.html");
    ...
    public void i_can_see_only_assignments_for_the_science_course() {
        ...
        wdw.until(ExpectedConditions.urlToBe("http://ec2-54-242-235-6.compute-1.amazonaws.com/s_view_assignments.html"));
        Assert.assertEquals(TestRunner.driver.getCurrentUrl(), "http://ec2-54-242-235-6.compute-1.amazonaws.com/s_view_assignments.html");
    }

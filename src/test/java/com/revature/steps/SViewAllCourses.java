...
public class SViewAllCourses {
    ...
    public void i_should_see_all_the_courses_for_the_student() {
        ...
        wdw.until(ExpectedConditions.urlToBe("http://ec2-54-242-235-6.compute-1.amazonaws.com/s_view_courses.html"));
        Assert.assertEquals(TestRunner.driver.getCurrentUrl(), "http://ec2-54-242-235-6.compute-1.amazonaws.com/s_view_courses.html");
    }
